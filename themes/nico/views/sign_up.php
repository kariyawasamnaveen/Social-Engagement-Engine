    ...
    <div class="app-wrapper">
        ...
        <div class="cosmic-panel">
            ...
            <div class="glass-form-box">
                <div class="form-tabs">
                    <div class="form-tab" onclick="window.location.href='<?=cn('auth/login')?>'">Sign in</div>
                    <div class="form-tab active">Sign Up</div>
                </div>
                ...
                <div class="form-inner">
                    <?php echo form_open($form_url, $form_attributes); ?>
                        ...
                        <div style="display: flex; gap: 10px;">
                            <div class="app-input-group" style="flex: 1;">
                        ...
                        <div class="custom-checkbox-wrapper">
                            ...
                            <label for="customCheck1">I agree to the <a href="<?=cn('terms')?>" target="_blank">Terms & Policy</a></label>
                        </div>
                        ...
                        <button class="app-btn-submit btn-submit" type="submit">SIGN UP</button>
                    <?php echo form_close(); ?>
                </div>
            </div>
