        ...
        <div class="cosmic-panel">
            ...
            <div class="glass-form-box">
                <div class="form-tabs">
                    ...
                    <div class="form-tab" onclick="window.location.href='<?=cn('auth/signup')?>'">Sign Up</div>
                </div>
                ...
                <div class="form-inner">
                    <?php echo form_open($form_url, $form_attributes); ?>
                        ...
                        <div class="app-input-group">
                            ...
                            <input type="email" name="email" value="<?=(isset($cookie_email) && $cookie_email != "") ? $cookie_email : '' ?>" placeholder="Enter your email" required>
                        </div>
                        
                        <div class="app-input-group">
                            <label>PASSWORD</label>
                            <input type="password" name="password" value="<?=(isset($cookie_pass) && $cookie_pass != "") ? $cookie_pass : ""?>" placeholder="••••••••" required>
                        </div>
                        
                        <div class="custom-checkbox-wrapper">
                            <input type="checkbox" id="remember" name="remember" value="1" <?=(isset($cookie_email) && $cookie_email != "") ? "checked" : ""?>>
                        ...
                        <button class="app-btn-submit btn-submit" type="submit">SIGN IN</button>
                    <?php echo form_close(); ?>
                    
                    <a href="<?=cn('auth/forgot_password')?>" class="forgot-text">Forgot Password?</a>
                </div>
            </div>
